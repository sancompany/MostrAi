...
PGPASSWORD=mostrai psql -h localhost -U mostrai -d mostrai -qc "UPDATE planos SET ponto_apos_meses=NULL, vagas=NULL, desconto_comodato_percentual=NULL; UPDATE planos_ponto SET plano_bonus_id=NULL, plano_bonus_apos_meses=NULL, plano_bonus_meses=NULL;"
