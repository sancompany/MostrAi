...
const ALIASES_ANTIGOS = {
  ...
  // geral, 23/09/2026) — os hashes antigos caem onde a tabela de comissão
  // ainda vive de verdade: a lista de vendedores (`vendedores`, oculto).
  // Precisa vir ANTES da linha identidade `vendedores: 'vendedores'` logo
  // abaixo — o mapa reverso (ALIAS_REVERSO, usado só pro subtítulo) usa a
  // última entrada que aponta pro mesmo destino, e é a identidade que deve
  // vencer aqui, não este alias legado.
