...
**Reverter para antes da migration 081 (Player V2):** o código antigo
autentica as TVs pela chave V1 em texto (`dispositivos.aparelho_id`), que a
081 manteve de propósito. Toda tela cuja credencial mudou depois do deploy
...
V1, sem credencial válida). Depois da migration 082 (que apaga a coluna de
todas), reverter para antes da 081 exige gerar o link de todas as TVs V1.
