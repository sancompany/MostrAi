...
console.log('== cadastro só-vendedor pelo convite ==');
{
  ...
  PG(`UPDATE anunciantes SET plano_id='essencial-3m', status='ativo', data_inicio_cobertura = now() - interval '2 months', data_expiracao = now() + interval '1 month', papeis = array_remove(papeis, 'ponto') WHERE id=${nina}`);
