...
console.log('== cadastro por convite ==');
{
  ...
  await p.fill('#cpf_cnpj', '12345678900'); await p.fill('#contato_telefone', '16 99999-1111');
...
check('convite de vendedor gerado', !!linkVend);
{
  ...
  await p.fill('#cpf_cnpj', '999'); await p.fill('#contato_telefone', '16 98888-2222'); await p.fill('#chave_pix', 'marcos@pix');
