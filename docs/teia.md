...
**GET /anunciantes/:id/exibicoes** — Dashboard agregado: totais programadas/confirmadas, confirmadasMes, porPonto (com ultima_vez_online), porDia, porDiaPonto (dia × ponto, pro gráfico empilhado), porHora, cobranças (sem nota fiscal), horasContratadasMes/horasEntreguesMes, exibicoesContratadasMes/exibicoesRestantesMes, mediaDiariaMes e custoPorExibicao.
