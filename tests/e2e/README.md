...
PW_CHROME=... node tests/e2e/12-meus-pontos.mjs    # um estabelecimento = um card, do pedido ao ponto no ar (tela instalada por código), sem F5 e sem duplicar; diálogo da tela sem PIN
