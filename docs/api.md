...
| PATCH | `/anunciantes/me` | Edita dados de contato/endereço. Endereço em partes (`cep`, `logradouro`, `numero`, `complemento`, `bairro`, `cidade`, `uf`): começou a preencher, preenche tudo (400 com a parte que falta; CEP de 8 dígitos); conta com papel `anunciante` não pode ficar sem endereço; conta só de ponto pode mandar tudo em branco (nada é gravado). |
