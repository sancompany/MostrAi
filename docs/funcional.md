...
- *Vazio:* rede sem ponto → "nenhum ponto cadastrado ainda"; ponto sem tela →
  "+ Tela" em destaque.
...
**RN-28 — Tela fora do ar não recebe playlist nem conta exibição.** Credencial
certa não basta: se a tela está em `reparo`/`inativo`, ou se o ponto
